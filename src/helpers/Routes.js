...
export const partnerImages = [
    { id: 1, src: `${baseUrl}/images/partners/partner1.png`, alt: 'Maroc Telecom' },
    ...
    { id: 5, src: `${baseUrl}/images/partners/partner5.png`, alt: 'Al Akhdar Bank' },
...
export const logo = `${baseUrl}/images/logo.png`
